                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="btn-group pull-right">
                                                <a class="btn blue" href="{{url('admin/carsdefault')}}">
                                                    Set Default						
                                                </a>
                                            </div>
                                        </div>
                                ...
                                @if(count($lists)>0)
                                    @foreach($lists as $key=>$list)
                                        <tr>
                                            ...
                                            <td>
                                                {{isset($list['icon']) ? $list['icon'] : ''}}
                                            </td>
                                            <td>
                                                {{isset($list['map_icon']) ? $list['map_icon'] : ''}}
                                            </td>
                                            <td>
                                                {{isset($list['price']) ? $list['price'] : ''}}
                                            </td>
                                            <td>
