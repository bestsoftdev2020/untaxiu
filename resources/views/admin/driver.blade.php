                    ...
                    <div class="col-md-12">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-users"></i>Driver List
                                </div>
                                <!-- <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li id="suspend">
                                                <a href="javascript:;">
                                                <i class="fa fa-trash-o"></i> Suspend </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div> -->
                                ...
                                @if(count($lists)>0)
                                    ...
                                    @foreach($lists as $key=>$list)
                                        <tr>
                                            ...
                                            <td>
                                                {{isset($list['model']) ? $list['model'] : ''}}
                                            </td>
                                            <td>
                                                {{isset($list['plate']) ? $list['plate'] : ''}}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if(isset($list['docsURL']))
                                                    <center><a href="{{$list['docsURL']}}" target="_blank"><i class="icon-link"></i></a></center>
                                                @else
                                                    <center><a href="#">Empty</a></center>
                                                @endif
                                            </td>
                                            <td>
                                                @if(isset($list['isApproved']) && ($list['isApproved']=='true'))
                                                    <center><a href="{{url('admin/driversuspend?lists='.$list['uid'])}}" class="label label-sm label-warning">Disapprove</a></center>
                                                @else
                                                    <center><a href="{{url('admin/driverapprove?lists='.$list['uid'])}}" class="label label-sm label-success">Approve</a></center>
                                                @endif
                                            </td>
                                            <td>
                                                <center><a href="{{url('admin/driverdelete?lists='.$list['uid'])}}" class="btn default btn-xs black"><i class="fa fa-trash-o"></i> Delete </a></center>
                                            </td>
                                        </tr>
                                        @php
                                            $i++;
