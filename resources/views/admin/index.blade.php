...
<!-------------------------------------------------------------------------------------------------------------------->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-car"></i>Ongoing Trips
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <ol id="gmap_marker_instructions">
                                </ol>
                            </div>
                        </div>
                        <!-- END ROUTES PORTLET-->
                    ...
                    <div class="col-md-12">
                        <div class="portlet box red-intense">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-globe"></i>Ongoing Trips
                                </div>
                                <div class="tools">
                                    <a href="javascript:;" class="collapse">
                                    </a>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCj8yfTtePpTRFmtGJqWTADsXpS_AWZQEA" type="text/javascript"></script>
    ...
    <script>
        jQuery(document).ready(function() {    
            var list_data = '<?php echo json_encode($lists); ?>';
            var lists = JSON.parse(list_data);
            Metronic.init(); // init metronic core componets
            Layout.init(); // init layout
            Demo.init(); // init demo features
            MapsGoogle.init(lists); 
            TableAdvanced.init();
        });
    </script>
</body>
