                    ...
                    <div class="col-md-12">
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-compass"></i>Trips List
                                </div>
                                <!-- <div class="actions">
                                    <div class="btn-group">
                                ...
                                @if(count($lists)>0)
                                    ...
                                    @foreach($lists as $key=>$list)
                                        <tr>
                                            ...
                                            <td>
                                                {{isset($list['endTime']) ? $list['endTime'] : ''}}
                                            </td>
                                            <td>
                                                {{$list['origin']['vicinity']}}
                                            </td>
                                            <td>
                                                {{$list['destination']['vicinity']}}
                                            </td>
                                            <td>
                                                {{$list['driverName']}}
                                            </td>
                                            ...
                                            <td>
                                                @if($list['status'] == 'finished')
                                                    <a href="#" class="label label-sm label-success">Finished</a>
                                                @elseif($list['status'] == 'waiting')
                                                    <a href="#" class="label label-sm label-warning">Waiting</a>
                                                @else
                                                    <a href="#" class="label label-sm label-danger">Canceled</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @php
