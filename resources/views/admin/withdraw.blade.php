                                ...
                                @if(count($lists)>0)
                                    ...
                                    @foreach($lists as $key=>$list)
                                        <tr>
                                            ...
                                            <td>
                                                @if(($list['status']=='CANCELED') || ($list['status']=='SUCCESS'))

                                                @else
                                                    <center><a href="{{url('admin/withdrawsend?lists='.$key)}}" class="label label-sm label-success">Send</a>&emsp;
                                                    <a href="{{url('admin/withdrawcancel?lists='.$key)}}" class="label label-sm label-danger">Cancel</a></center>
                                                @endif
                                            </td>
                                        </tr>
                                        @php
